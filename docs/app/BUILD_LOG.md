...
| 2026-03-30 | 0.9.0 | 17 | Android (APK+AAB) | Engine handoff docs, .env config, Beat This! engine toggle, remove real-time edition sync, fix pause→play grid lag, fix analysis queue (Alert stacking, done-state block), cache bypass for testing |
